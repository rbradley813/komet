...
public class HelloWorldNodeFactory implements KometNodeFactory {
    private static final Logger LOG = LoggerFactory.getLogger(HelloWorldNodeFactory.class);

    protected static final String STYLE_ID = HelloWorldNode.STYLE_ID;
    protected static final String TITLE = HelloWorldNode.TITLE;
    
	public static HelloWorldNodeFactory provider() {
		return new HelloWorldNodeFactory();
	}

	public HelloWorldNodeFactory() {
		super();
	}
    ...
    @Reconstructor
    public static HelloWorldNode reconstructor(ObservableViewNoOverride windowView, KometPreferences nodePreferences) {
        return new HelloWorldNode(windowView.makeOverridableViewProperties(), nodePreferences);
    }
    @Override
    ...
    public KometNode create(ObservableViewNoOverride windowView, KometPreferences nodePreferences, boolean displayOnJournalView) {
        return new HelloWorldNode(windowView.makeOverridableViewProperties(), nodePreferences, displayOnJournalView);
    }
